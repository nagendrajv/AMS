...
if(appId != null) {
	...
	String query = "select rel.release_id, rel.release_name, DATE_FORMAT(rel.release_Date,'%m-%d-%Y') as release_Date, rel.release_type, if(rel.release_promoted=1, 'QA/Prod', 'QA') as promoted, rel.release_comments, rel.release_notes_URL, rel.created_by, rel.release_status from smsdb.releases rel where rel.app_id="+appId+" order by rel.release_Date desc";
	System.out.println("##View Releases="+query);
